...
func TestTransferTx(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		_, err2 := store.GetTransfer(context.Background(), transfer.ID)
		...
		fmt.Println(">> tx: fromAccount.Balance = ", fromAccount.Balance,
	...
	fmt.Println(">> after: updatedAccount1.Balance = ", updatedAccount1.Balance,
		" updatedAccount2.Balance = ", updatedAccount2.Balance)
